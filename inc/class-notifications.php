 ...
 * Notifications.
 */
class SFR_Notifications {
    /**
     * @var string
     */
    private static $process_queue_name = 'sfr_process_email_queue';

    /**
     * @var string
     */
    private static $queue_option_name = 'sfr_email_queue';
    ...
    public static function get_post_created_email( $feature_request ) {
        ob_start();
        sfr_do_action( 'sfr_before_post_created_email_body', $feature_request );
        sfr_do_action( 'sfr_before_email_body', $feature_request );
        ?>
		<p><?php 
        ...
        ?>
		<?php 
        sfr_do_action( 'sfr_after_post_created_email_body', $feature_request );
        sfr_do_action( 'sfr_after_email_body', $feature_request );
        return ob_get_clean();
    }
    ...
    public static function get_signature() {
        ...
        $signature = sfr_apply_filters( 'sfr_email_signature', $signature );
    ...
    public static function is_comment_for_request( $comment_id ) {
        ...
        return $post_type === SFR_Post_Types::$key;
    }
