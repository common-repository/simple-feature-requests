...
if ( class_exists( 'SFR_Core_Licence' ) ) {
    return;
}
/**
 * SFR_Core_Licence.
 *
 * @class    SFR_Core_Licence
 */
class SFR_Core_Licence {
    /**
     * Single instance of the SFR_Core_Licence object.
     *
     * @var SFR_Core_Licence
     */
    ...
    /**
     * Creates/returns the single instance SFR_Core_Licence object.
     *
     * @return SFR_Core_Licence
     */
    ...
    public static function output_back_to_settings_link() {
        if ( !SFR_Core_Settings::is_settings_page( '-account' ) ) {
            return;
        }
        ?>
    ...
    public static function add_action_links( $links ) {
        $links[] = sprintf( '<a href="%s" target="_blank">%s</a>', self::$args['urls']['product'] . '/changelog/?utm_source=SFR&utm_medium=Plugin&utm_campaign=simple-feature-requests&utm_content=changelog-link', __( 'Changelog', 'simple-feature-requests' ) );
        return $links;
    }
    ...
    public static function admin_account_link() {
        if ( self::has_valid_licence() ) {
            return sprintf( '<a href="%s" class="button button-secondary">%s</a>', self::$args['urls']['account'], __( 'Manage License &amp; Billing', 'simple-feature-requests' ) );
        }
        return Simple_Feature_Requests::get_pro_button();
    }
